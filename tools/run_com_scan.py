...
SCRIPT = ROOT / "tools" / "find_missing_class.js"
...
def main() -> int:
    ...
    def on_message(message, _data):
        ...
        handle.flush()
        if kind in ("com-create-FAILED", "com-getclass-FAILED", "com-create", "ready", "hooked", "absent"):
            print(json.dumps(payload), flush=True)
            if kind in ("com-create-FAILED", "com-getclass-FAILED"):
