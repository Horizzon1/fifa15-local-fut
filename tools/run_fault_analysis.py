...
SCRIPT = ROOT / "tools" / "analyze_fault.js"
...
def main() -> int:
    ...
    def on_message(message, _data):
        ...
        handle.flush()
        if kind in ("FAULT", "disasm", "audio-api", "audio-module", "co-create-failed", "analyzer-ready", "module", "hooked"):
            print(json.dumps(payload), flush=True)
            if kind in ("FAULT", "audio-api"):
